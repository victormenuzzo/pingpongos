...
void pingpong_init()
{
    ...
    // registra a a��o para o sinal de timer SIGALRM
	  ...
	  timer.it_value.tv_usec = 1120;      // primeiro disparo, em micro-segundos alteramos de 1000ms para 1120 pois 1000 estava dando errado
	  timer.it_value.tv_sec  = 0.001;      // primeiro disparo, em segundos
	  timer.it_interval.tv_usec = 1120;   // disparos subsequentes, em micro-segundos  alteramos de 1000ms para 1120 pois 1000 estava dando errado
